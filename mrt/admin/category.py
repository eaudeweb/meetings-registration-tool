...
class CategoryClassEdit(PermissionRequiredMixin, MethodView):
    ...
    def delete(self, category_class_slug):
        ...
        categories_nr = (Category.query
                        .filter_by(category_class_slug=category_class_slug)
                        .count())
